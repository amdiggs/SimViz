...
private:
    ...
    unsigned int m_clrs_vbo, m_offset_vbo, m_types_vbo;
...
private:
    VertexArray m_VAO;
    IndexBuffer m_IBO;
    const std::string shader_file = "/Users/diggs/Desktop/VolumeData/Resources/Shaders/Atom_AO.vs";
    int m_num_verts, m_num_indx;
    Shader m_sh;
    
    
    unsigned int m_vert_vbo, m_amb_vbo;
    AMD::Vertex_Basic* m_verts = NULL;
    float* m_ambient = NULL;
    int* m_indices = NULL;
...
private:
    VertexArray m_VAO;
    const std::string shader_file = "/Users/diggs/Desktop/VolumeData/Resources/Shaders/Bond.vs";
    int m_num_verts;
    Shader m_sh;
...
private:
    ...
    AMD::Vec4* m_clrs = NULL;
    AMD::Vec4 m_clr;
    unsigned int m_pos_vbo, m_clr_vbo, m_gs_val_vbo;
    unsigned int m_count;
    
    unsigned int m_max_el;
    float* m_gs_vals = NULL;
