...
public:
    ...
    virtual void Set_Uniforms(Light_Src& src) = 0;
    virtual void Set_Shader() = 0;
    virtual void Draw() = 0;
};

class Atoms_Mesh : public Mesh{
private:
    VertexArray m_VAO;
    IndexBuffer m_IBO;
...
class Iso_Mesh : public Mesh{
private:
    const std::string shader_file = "./Shaders/iso2.vs";
    const std::string grid_shader_file = "./Shaders/iso.vs";
    VertexArray m_VAO;
    Shader m_sh;
    Shader grid_sh;
    AMD::Vec3* m_pos = NULL;
